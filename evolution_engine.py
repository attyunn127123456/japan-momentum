...
def local_search(baseline_params, factor_dfs, prices_dict, nikkei, date_map, fund_factors=None):
    ...
    RANGES = {
        ...
        'range_mean_reversion_speed_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'low_vol_retracement_quality_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'price_ratchet_efficiency_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'open_position_in_range_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'range_acceleration_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'sequential_gap_autocorr_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'close_dispersion_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'range_autocorrelation_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'opening_drive_w_v1':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'volume_price_lead_lag_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'cusum_break_recency_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'return_entropy_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'up_volume_ratio_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'atr_regime_change_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'cross_rank_stability_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'sector_outperformance_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'volume_at_high_ratio_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'up_run_persistence_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'log_return_kurtosis_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'shadow_ratio_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'garman_klass_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'price_path_convexity_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'rolling_shallow_dd_rank_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'market_vol_scaling_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'rank_acceleration_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'exp_decay_momentum_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'sector_relative_dd_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'conditional_volume_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'tail_risk_ratio_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'hurst_trend_persistence_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'overnight_return_asymmetry_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'ret_dispersion_timing_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'time_near_high_ratio_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'loss_correlation_penalty_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'mfe_mae_ratio_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'drawdown_velocity_exit_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'sector_momentum_dispersion_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'portfolio_dd_cap':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'consecutive_higher_close_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'volume_weighted_momentum_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'relative_range_position_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'vwap_drift_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'variance_ratio_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'volume_concentration_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'gap_recovery_strength_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'close_high_ratio_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'stress_efficiency_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'run_quality_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'vol_price_corr_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'support_bounce_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
        'rel_vol_trend_w':          [0.0, 0.05, 0.1, 0.15, 0.2],
